...
# Source .cpp
_SRC=vd.cpp point.cpp variables.cpp linesegment.cpp circle.cpp
SRC=$(patsubst %.cpp, $(SDIR)/%.cpp, $(_SRC))

# Dependencies .h
_DEPS=vd.h point.h variables.h linesegment.h circle.h
DEPS=$(patsubst %.h, $(IDIR)/%.h, $(_DEPS))

# Objects .o
_OBJ=vd.o point.o variables.o linesegment.o circle.o
